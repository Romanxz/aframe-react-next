// @ts-nocheck
import vertexPars from '../shaders/morph/vertex_pars.glsl'
import vertexMain from '../shaders/morph/vertex_main.glsl'
import fragmentPars from '../shaders/morph/fragment_pars.glsl'
import fragmentMain from '../shaders/morph/fragment_main.glsl'

AFRAME.registerComponent('morphshader', {
  schema: {
  ...
  init: function () {
    ...
    console.log("[morphshader] initialized: ", this.material)
  },
